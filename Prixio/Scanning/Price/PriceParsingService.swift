...
enum PriceParsingService {
    ...
    private struct ItemNameCandidate {
        let line: String
        let score: Int
        let lineIndex: Int
    }
    ...
    private static let itemNameIgnoredTokens: Set<String> = [
        "sale",
        "member",
        "members",
        "club",
    ...
    private static func scoredItemNameCandidate(
        for line: String,
        lineIndex: Int,
        priceCandidates: [PriceCandidate],
        observations: [OCRTextObservation]
    ...
    private static func topCandidateProximityBoost(
        lineIndex: Int,
        priceCandidates: [PriceCandidate],
        observations: [OCRTextObservation]
    ) -> Int {
    ...
    private static func looksLikeReceiptFragment(_ text: String) -> Bool {
        let lowered = text.lowercased()
    ...
    private static func isPureUnitToken(_ token: String) -> Bool {
